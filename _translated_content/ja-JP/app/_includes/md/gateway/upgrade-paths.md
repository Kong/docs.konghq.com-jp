...
| **現在のバージョン** | **トポロジー** | **直接アップグレードは可能ですか？** | **アップグレードパス** |
|\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-|\-\-\-\-\-\-\-\-\-\-\-\-|\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-|\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-|
| 2\.x—2\.7\.x | 従来モード | いいえ | 2\.8\.2\.xへのアップグレード（ブルー/グリーンデプロイメントのみの場合は必須）、3\.4\.xにアップグレードし、3\.5\.xにアップグレードし、3\.6\.x にアップグレードし、その後、3\.7\.xにアップグレードします。|
| 2\.x–2\.7\.x | ハイブリッドモード | いいえ | 2\.8\.2\.xにアップグレードし、3\.4\.xにアップグレードし、3\.5\.xにアップグレードし、3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 2\.x–2\.7\.x | DBレスモード | いいえ | 3\.0\.xにアップグレードし、3\.1\.xにアップグレードし、3\.2\.xにアップグレードし、3\.3\.xにアップグレードし、3\.4\.xにアップグレードし、3\.5\.xにアップグレードし、3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 2\.8\.x | 従来モード | いいえ | [LTSアップグレード](/gateway/{{page.release}}/upgrade/lts-upgrade/)経由で3\.4\.xにアップグレードし、3\.5\.xにアップグレードし、3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 2\.8\.x | ハイブリッドモード | いいえ | [LTSアップグレード](/gateway/{{page.release}}/upgrade/lts-upgrade/)経由で3\.4\.xにアップグレードし、3\.5\.xにアップグレードし、3\.6\.x にアップグレードし、その後、3\.7\.xにアップグレードします。 |
| 2\.8\.x | DBなしモード | いいえ | [LTSアップグレード](/gateway/{{page.release}}/upgrade/lts-upgrade/)経由で3\.4\.xにアップグレードし、3\.5\.xにアップグレードし、3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 3\.0\.x | 従来モード | いいえ | 3\.4\.xにアップグレードし、3\.5\.xにアップグレードし、3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 3\.0\.x | ハイブリッドモード | いいえ | 3\.4\.xにアップグレードし、3\.5\.xにアップグレードし、3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 3\.0\.x |DBレスモード |いいえ | 3\.4\.xにアップグレードし、3\.5\.xにアップグレードし、3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 3\.1\.x | 従来モード | いいえ | 3\.4\.xにアップグレードし、3\.5\.xにアップグレードし、3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 3\.1\.0\.x\-3\.1\.1\.2 | ハイブリッドモード | いいえ | 3\.1\.1\.3にアップグレードして、3\.2\.xにアップグレードし、3\.3\.xにアップグレードし、3\.4\.xにアップグレードし、3\.5\.xにアップグレードし、3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 3\.1\.1\.3 | ハイブリッドモード | いいえ | 3\.4\.xにアップグレードし、3\.5\.xにアップグレードし、3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 3\.1\.x | DBレスモード | いいえ | 3\.4\.xにアップグレードし、3\.5\.xにアップグレードし、3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 3\.2\.x | 従来モード | いいえ | 3\.4\.xにアップグレードし、3\.5\.xにアップグレードし、3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 3\.2\.x | ハイブリッドモード | いいえ | 3\.4\.xにアップグレードし、3\.5\.xにアップグレードし、3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 3\.2\.x | DBレス | いいえ | 3\.4\.xにアップグレードし、3\.5\.xにアップグレードし、3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 3\.3\.x | 従来モード | いいえ | 3\.4\.xにアップグレードし、3\.5\.xにアップグレードし、3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 3\.3\.x | ハイブリッドモード | いいえ | 3\.4\.xにアップグレードし、3\.5\.xにアップグレードし、3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 3\.3\.x | DBレス | いいえ | 3\.4\.xにアップグレードし、3\.5\.xにアップグレードし、3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 3\.4\.x | 従来モード | いいえ | 3\.5\.xへのアップグレードし、3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 3\.4\.x | ハイブリッドモード | いいえ | 3\.5\.xにアップグレードし、3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 3\.4\.x | DBレス | いいえ | 3\.5\.xにアップグレードし、3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 3\.5\.x | 従来モード | いいえ | 3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 3\.5\.x | ハイブリッドモード | いいえ | 3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 3\.5\.x | DBレスモード | いいえ | 3\.6\.xにアップグレードし、その後、3\.7\.xにアップグレードします。|
| 3\.6\.x | 従来モード | はい | 3\.7\.xにアップグレードします。|
| 3\.6\.x | ハイブリッドモード | はい | 3\.7\.xにアップグレードします。|
| 3\.6\.x | DBなし | はい | 3\.7\.xにアップグレードします。|
